...
![Graph Normal](../graphs/Minimax_chessbot_runtime.png)
![Graph Log-scale](https://github.com/Tseegi-N/Minimax-Chess-on-CUDA/blob/master/graphs/Minimax_chessbot_Runtime_log_scale.png)
